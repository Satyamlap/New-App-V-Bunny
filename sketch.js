...
createCanvas(can_w,can_h);
  ...
  /*air_blower = createImg("balloon.png");
  air_blower.position(10,250);
  air_blower.size(140,140);
  air_blower.mouseClicked(forceX)*/
  
  mute_btn = createImg("mute.png")
  mute_btn.position(430,10);
  mute_btn.size(40,40);
  mute_btn.mouseClicked(mute_off_on)

  rope = new Rope(5,{x:245,y:30});

  rope2 = new Rope(5,{x:370,y:110})

  rope3 = new Rope(6,{x:75,y:200});
